...
gulp.task('js:hint', function () {
	...
	console.log('-------------------------------------------------- JS - HINT');
	var stream = gulp.src([SETTINGS.src.js + 'app.js', '!' + SETTINGS.src.js + 'libs/*.js', '!' + SETTINGS.src.js + 'plugins/*.js', SETTINGS.src.js + '**/*.js', 'gulpfile.js'])
...
gulp.task('concat', ['concat:bower', 'concat:js', 'concat:css', 'concat:json']);
...
gulp.task('concat:json', function () {
	...
	gulp.src([SETTINGS.src.json + '*.json', SETTINGS.src.json + '**/*.json'])
...
gulp.task('concat:js', ['js:hint'], function () {
	...
	gulp.src([SETTINGS.src.js + 'plugins/*.js', SETTINGS.src.js + 'app.js', SETTINGS.src.js + 'services/**/*.js', SETTINGS.src.js + '*.js', SETTINGS.src.js + '**/*.js', SETTINGS.src.js + '**/**/*.js',])
	    .pipe(gulpPlugins.concat('all.js'))
	    .pipe(gulpPlugins.if(isProduction, gulpPlugins.uglify()))
	    .pipe(gulp.dest(SETTINGS.build.js))
	    .pipe(gulpPlugins.connect.reload());

	// return gulp.src([SETTINGS.src.js + 'libs/*.js', SETTINGS.src.js + 'app.js', SETTINGS.src.js + '*.js', SETTINGS.src.js + '**/*.js'])
	//     .pipe(gulpPlugins.concat('all.js'))
	//     .pipe(gulpPlugins.if(isProduction, gulpPlugins.uglify()))
	//     .pipe(gulp.dest(SETTINGS.build.js))
	//     .pipe(gulpPlugins.connect.reload());
...
gulp.task('copy:html', function () {
	...
	gulp.src([SETTINGS.src.templates + '*.html', SETTINGS.src.templates + '**/*.html', '!' + SETTINGS.src.templates + '/**/' + SETTINGS.src.escape + '/*.*', '!' + SETTINGS.src.templates + '/' + SETTINGS.src.escape + '/*.*'])
...
gulp.task('watch', function () {
    ...
    watchedFiles.push(gulp.watch([SETTINGS.src.js + '*.js',    SETTINGS.src.js + '**/*.js',  SETTINGS.src.js + '**/**/*.js'],    ['concat:js']));
